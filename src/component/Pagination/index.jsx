...
class Pagination extends React.Component {
  static propTypes = {
    ...
    showSizeChanger: PropTypes.bool, //licni
    showLessItems: PropTypes.bool,
    onShowSizeChange: PropTypes.func, //licni
  ...
  getItemIcon = (icon) => {
    const { prefixCls } = this.props;
    let iconNode = icon ? <a href="#?" className={`${prefixCls}-item-link`} style={{textDecoration: "none"}}></a> : null;
  ...
  render() {
    ...
    const locale = props.locale[this.props.lang];
